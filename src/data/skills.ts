...
export const skillCategories: SkillCategory[] = [
  ...
  },
  {
    ...
    color: "29,99,237",
    skills: [
      { name: "Docker", colorClass: "tag--docker", x: 35, y: 10, iconColor: "29,99,237" },
      { name: "Azure", colorClass: "tag--azure", x: 70, y: 50, iconColor: "0,120,212" },
      { name: "AWS EC2", colorClass: "tag--aws", x: 30, y: 90, iconColor: "255,153,0" },
      { name: "Git", colorClass: "tag--git", x: 65, y: 130, iconColor: "240,80,50" },
      { name: "CI/CD", colorClass: "tag--ci", x: 45, y: 170, iconColor: "0,120,212" },
      { name: "GitHub Actions", colorClass: "tag--gha", x: 66, y: 210, iconColor: "32,136,255" },
    ],
  },
  {
    name: "Methods & Design",
    color: "162,89,255",
    skills: [
      { name: "Agile / Scrum", colorClass: "tag--agile", x: 50, y: 10, iconColor: "0,255,200" },
      { name: "SOLID", colorClass: "tag--solid", x: 25, y: 50, iconColor: "123,97,255" },
      { name: "SSO", colorClass: "tag--sso", x: 70, y: 90, iconColor: "255,153,0" },
      { name: "Atomic Design", colorClass: "tag--atomic", x: 35, y: 130, iconColor: "0,255,200" },
      { name: "Clean Code", colorClass: "tag--clean", x: 65, y: 170, iconColor: "200,200,200" },
      { name: "Testing", colorClass: "tag--testing", x: 30, y: 210, iconColor: "62,207,142" },
    ],
  },
];
